...
public class InputZipCode extends Activity {
	private EditText enteredZipCode;
	private int mSuccessful;
	private TableRow indicatorRow;
	private ProgressBar progressBar;
	private TextView indicatorText, titleView, messageView;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.input_zipcode);
        dBAdapter = new MyLegislatorDatabaseAdapter(mContext);
    	dBAdapter.open();
        findViews();
        getIntentExtras();
        setText();
        InnerPanel innerPanel = (InnerPanel)findViewById(R.id.inner_panel);
	...
	private void findViews() {
        ...
        titleView  = (TextView)findViewById(R.id.input_screen_title);
        messageView  = (TextView)findViewById(R.id.input_screen_message);
	}
